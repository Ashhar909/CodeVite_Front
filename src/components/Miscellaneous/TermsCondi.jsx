    ...
    <div id="terms">
      ...
      <section id="section">
        ...
        <p>
          ...
          or contributors of content. Please read these Terms of Service
      ...
      <section id="section">
        <h3>SECTION 1 - SITE USAGE TERMS</h3>
        <p>
      ...
      <section id="section">
        ...
        <p>
          ...
          site is void where prohibited. We might use contents/references from
          third party vendors and when you agree to use our services, you also
          agree not to create any commotion /take any legal action against us
          regarding this matter. We do not warrant that the quality of any
      ...
      <section id="section">
        ...
        <p>
          ...
          non-infringement. In no case shall Codevita Live, our directors,
      ...
      <section id="section">
        ...
        <p>
          You agree to indemnify, defend and hold harmless Codevita Live and our
      ...
      <section id="section">
        ...
        <p>
          ...
          laws of India and jurisdiction of Pune, Maharashtra.
        </p>
      </section>
      <section id="section">
